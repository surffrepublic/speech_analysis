...
rails g scaffold speaker name:string city:references state:references country:references native_language:references other_languages:integer age:integer english_onset:integer learning_method:integer english_country_residence:references length_english_residence:integer user:references
